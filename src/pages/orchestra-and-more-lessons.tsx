...
export default function OrchestraLessonsPage() {
  return (
    <PageShell
      ...
      description="Develop your musical skills at Apex Conservatory with Orchestra and More Lessons, from basics to ensemble performance for all ages."
      sidebar={<LinkCard title="The Arts" links={artsLinks} />}
    >
      <Typography variant="h1" sx={{ mb: 2 }}>
        Apex Conservatory of Music Classes
      </Typography>
      ...
      <SiteForm
        ...
        fields={[
          ...
          },
          {
            kind: "select",
            name: "hearAbout",
            label: "How did you hear about Apex Academy Minnesota?",

...
export default function DonatePage() {
  return (
    <PageShell
      title="Donate - Veritas Academy"
      description="Invest in students at Veritas Academy who are being intentionally prepared to lead with clarity and virtue."
    ...
    >
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        Students at Veritas Academy are being intentionally prepared to lead with clarity and virtue. Guided by Biblical principles, we combine academic rigor with love and compassion, to equip young people with an exceptional, Christ centered education that will transform our world.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
      ...
      <Typography variant="body1" sx={{ mb: 3 }}>
        When you give to Veritas Academy, you are making a lifetime investment in the lives of students who have chosen an exceptional education.
      </Typography>
      <Typography variant="h2" sx={{ mb: 1 }}>
        Ways to Give
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        You may use the link on this page to make a one time donation or monthly gifts through a direct and secure donation or by check, to Veritas Academy. We appreciate your support.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        Veritas donors choose from several levels of giving:
      </Typography>
      <GivebutterWidget />
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        When you make a planned gift to Veritas Academy through your will or estate plan, you become a member of the Legacy Society – a special group of our strongest supporters – that helps sustain quality programming for future generations. Other options include:
      </Typography>
      <Typography variant="body1" sx={{ mb: 1 }}>
        Planned Giving
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        Even people of modest means can make a big difference through a planned gift! Including Veritas Academy in your will or trust allows you to make a gift that costs you nothing during your lifetime. By making a planned gift through your will or estate plan, you ensure Veritas Academy’s commitment to excellence and the advancement of the Gospel of Jesus Christ and His Kingdom endures for future generations.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        Members of Veritas Academy’s Legacy Society are individuals who’ve demonstrated forethought and generosity to ensure that as part of their legacy, more children in our community will have access to Veritas Academy’s Christ-centered education. These commitments allow Veritas Academy to plan – and build – into the future.
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        I give, devise, and bequeath to Veritas Academy, a non-profit corporation located at 34888 Kable Avenue, North Branch, Minnesota, the sum of $___________ as an unrestricted gift. Tax ID: {site.taxId}.
      </Typography>
      <Typography variant="body1" sx={{ mb: 1 }}>
        Estate Percentage Will or Trust Bequest Language:
      </Typography>
      <Typography variant="body1" sx={{ mb: 2 }}>
        I give, devise, and bequeath to Veritas Academy, a non-profit corporation located at 34888 Kable Avenue, North Branch,, Minnesota, _____ percent of my estate as an unrestricted gift. Tax ID: {site.taxId}
      </Typography>
      <Typography variant="body1" sx={{ mb: 3 }}>
        Contact Susie Brooks, EdD at <SiteLink href={`mailto:${site.presidentEmail}`}>{site.presidentEmail}</SiteLink> for additional assistance or questions about planned gifts to Veritas Academy.
      </Typography>
      <Typography variant="body1" sx={{ mb: 1 }}>
        Donor-Advised Fund
      </Typography>
      ...
      <Typography variant="body1" sx={{ mb: 2 }}>
        Make a difference today through Qualified Charitable Distribution (QCD) and save on taxes. You can give any amount (up to a maximum of $100,000) per year from your IRA directly to Veritas Academy without having to pay income taxes on the money. This popular gift option is commonly called the IRA charitable rollover, but you may also see it referred to as a qualified charitable distribution, or QCD for short. Gifts of any value $100,000 or less are eligible for this benefit.
      </Typography>
      ...
      <Typography variant="body1" sx={{ mb: 3 }}>
        Please contact your financial advisor and/or retirement plan administrator to complete your gift. Also, please also inform Veritas Academy’s President Susie Brooks, EdD at <SiteLink href={`mailto:${site.presidentEmail}`}>{site.presidentEmail}</SiteLink> of your gift intention. We would love to talk further about your intentions to ensure they are followed.
      </Typography>
      <Typography variant="h4" sx={{ mb: 1 }}>
        Kingdom Builder ($100,000+)
      </Typography>
      <Typography variant="body1" sx={{ mb: 1 }}>
        When you make a commitment at the Kingdom Builder level, you join a select group of dedicated donors who support Veritas Academy’s mission to make an impactful difference. This can be a one-time gift or it can be spread over a period of time.
      </Typography>
      ...
      <Typography variant="body1">
        Veritas Academy is registered as a 501 (c) 3 nonprofit and your contribution is tax deductible to the full extent of tax law.
      </Typography>
    </PageShell>
  );
}
